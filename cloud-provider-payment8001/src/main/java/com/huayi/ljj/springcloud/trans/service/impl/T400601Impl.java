...
import com.huayi.ljj.springcloud.trans.pojo.resp.Resp40601;
...
public class T400601Impl implements T400601 {
    ...
    public void execute(IServiceContext context) {
        ...
        Resp40601 resp40601 = new Resp40601();
        resp40601.setOrderNo(req.getOrderNo());

        context.setBaseResp(resp40601);
